...
Waiting is what virtual threads are good at, and web handlers spend most of their time waiting for I/O.
...
And a virtual thread remains pinned to its carrier platform thread while it executes native code.
