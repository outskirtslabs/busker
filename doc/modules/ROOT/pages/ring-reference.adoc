...
This reference lists the request fields Busker supplies, the response forms it accepts, and known compatibility limits.
See xref:guides/ring-compatibility.adoc[Ring compatibility] for the reasons behind its handler and streaming model.
