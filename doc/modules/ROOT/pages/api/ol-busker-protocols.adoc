...
[.api-source]
link:https://github.com/outskirtslabs/busker/blob/main/src/main/clojure/ol/busker/protocols.clj#L12-L77[source,window=_blank]
...
Returns false after the native response writer stops.
   ...
   This value may remain true briefly after <<close,`close`>> requests stream completion.
