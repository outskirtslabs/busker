...
<<SizableResponseBody,`SizableResponseBody`>> supplies known byte sizes for complete responses. <<ResponseEmitter,`ResponseEmitter`>>
...
[.api-source]
link:https://github.com/outskirtslabs/busker/blob/main/src/main/clojure/ol/busker/protocols.clj#L13-L18[source,window=_blank]
...
Controls an asynchronous server-to-client stream for one HTTP response.
 ...
 The stream closes when application code calls <<close,`close`>>, a final response completes,
 or libh2o reports request termination.

_protocol_

[.api-source]
link:https://github.com/outskirtslabs/busker/blob/main/src/main/clojure/ol/busker/protocols.clj#L20-L100[source,window=_blank]
